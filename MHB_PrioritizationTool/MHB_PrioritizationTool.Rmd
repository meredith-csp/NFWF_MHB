...
if (!require("pacman")) install.packages("pacman",repos = "http://cran.us.r-project.org")
  pacman::p_load(rmarkdown, flexdashboard, zonator, raster, rgdal, rgeos, leaflet, mapview, RColorBrewer) #shinydashboard, 
...
For further instructions, more information on the input data and prioritization algorithm, and other supporting information, view or download the [full documentation](https://drive.google.com/open?id=1sOPr7kSgzBG8BNh66u3jwUP-ackppJagv9uay6Rxo3Q). 
